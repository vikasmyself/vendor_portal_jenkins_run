...
class SeleniumDriver():
    ...
    def screenShot(self, resultMessage):
        ...
        folder_name = f'/Users/vmata/Documents/New_Sess/vendor_portal/screenprints/screenprints{folder_timestamp}'
        #folder_name = os.path.join("vendor_portal","screenprints", folder_timestamp)
